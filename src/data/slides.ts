...
export const slides: SlideData[] = [
  ...
  },
  {
    ...
    title: ["GROUP MEMBERS"],
    members: [
      { name: "LÊ QUỲNH NHI", role: "DEFINITION, OPERATING PRINCIPLE, CONCLUSION" },
      { name: "NGUYỄN NGỌC THANH TRÂM", role: "CURRENT DEVELOPMENT STATUS" },
      { name: "LÊ GIA BẢO", role: "CHALLENGES" },
      { name: "PHẠM NGỌC TRỌNG", role: "SOLAR POTENTIAL IN VIETNAM" },
      { name: "LÊ ĐĂNG KHƯƠNG", role: "ADVANTAGES" },
      { name: "VŨ NGỌC HÙNG CƯỜNG", role: "SUSTAINABLE SOLUTIONS" },
    ],
